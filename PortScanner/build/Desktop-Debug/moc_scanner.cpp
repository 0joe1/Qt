...
QT_MOC_LITERAL(1, 8, 9), // "port_open"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "portnum"
QT_MOC_LITERAL(4, 27, 11), // "sigProgress"
QT_MOC_LITERAL(5, 39, 8), // "progress"
QT_MOC_LITERAL(6, 48, 10) // "start_scan"

    },
    "Scanner\0port_open\0\0portnum\0sigProgress\0"
    "progress\0start_scan"
};
...
void Scanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->port_open((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sigProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->start_scan(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scanner::port_open)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scanner::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scanner::sigProgress)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Scanner::port_open(int _t1)
{
...
// SIGNAL 1
void Scanner::sigProgress(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
