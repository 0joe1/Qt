...
QT_MOC_LITERAL(3, 28, 11) // "emit_signal"

    },
    "Sonwidget\0show_hide_signal\0\0emit_signal"
};
...
void Sonwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->show_hide_signal(); break;
        case 1: _t->emit_signal(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sonwidget::*)();
...
// SIGNAL 0
void Sonwidget::show_hide_signal()
{
