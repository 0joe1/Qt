...
QT_MOC_LITERAL(5, 42, 17), // "installMouseEvent"
QT_MOC_LITERAL(6, 60, 16) // "removeMouseEvent"

    },
    "MouseEvent\0mouseEvent\0\0QMouseEvent*\0"
    "event\0installMouseEvent\0removeMouseEvent"
};
...
void MouseEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->installMouseEvent();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { bool _r = _t->removeMouseEvent();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
        ...
        {
            using _t = void (MouseEvent::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MouseEvent::mouseEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MouseEvent::mouseEvent(QMouseEvent * _t1)
{
