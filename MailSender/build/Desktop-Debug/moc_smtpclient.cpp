...
QT_MOC_LITERAL(1, 11, 14), // "readyConnected"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9), // "encrypted"
QT_MOC_LITERAL(4, 37, 15) // "socketEncrypted"

    },
    "SmtpClient\0readyConnected\0\0encrypted\0"
    "socketEncrypted"
};
...
void SmtpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->readyConnected(); break;
        ...
        {
            using _t = void (SmtpClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SmtpClient::encrypted)) {
                *result = 1;
                return;
            }
        }
